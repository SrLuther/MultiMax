...
from ..services.notificacao_service import criar_mensagem_personalizada, enviar_relatorio_diario, gerar_relatorio
...
def index():
    ...
    return render_template(
        "notificacoes.html", active_page="notificacoes", eventos=eventos, msgs=msgs, historico=historico, previa=prev
    )
