...
ATTENTION_PATTERNS = [
    'Evento onclick inline',
    'Evento onchange inline',
    'Evento onsubmit inline'
]
...
if __name__ == '__main__':
    ...
    if temp_file.exists():
        ...
        print("Arquivo temp_alerts.txt não encontrado. Execute primeiro: python tools/js_safety_check.py > temp_alerts.txt")
        sys.exit(1)
