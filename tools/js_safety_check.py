...
PATTERNS = {
    ...
    "inline_onclick": {"description": "Evento onclick inline", "pattern": r"\bonclick\s*=", "flags": re.IGNORECASE},
    "inline_onchange": {"description": "Evento onchange inline", "pattern": r"\bonchange\s*=", "flags": re.IGNORECASE},
    "inline_onsubmit": {"description": "Evento onsubmit inline", "pattern": r"\bonsubmit\s*=", "flags": re.IGNORECASE},
    "innerhtml_usage": {
...
def find_all_occurrences(content, pattern_name, pattern_info):
    ...
    for match in re.finditer(pattern, content, flags):
        ...
        occurrences.append({"line": line_num, "match": match.group(0), "line_content": line_content})
...
def check_file(file_path):
    ...
    try:
        ...
        return [{"type": "ERRO_LEITURA", "line": 0, "message": f"Erro ao ler arquivo: {e}"}]
    ...
    for pattern_name, pattern_info in PATTERNS.items():
        ...
        for occ in occurrences:
            alerts.append({"type": pattern_info["description"], "line": occ["line"], "snippet": occ["line_content"]})
