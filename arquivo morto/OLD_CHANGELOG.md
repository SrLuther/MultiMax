...
## [3.7.8] - 2026-02-03 08:00:00

### ✅ Fix: Type Checking Errors and Code Quality
- **fix(models/logs_auth.py)**: Add proper typing import to resolve `db.Model` type checking
- **fix(migrate_sqlite_to_postgres_vps.py)**: Add None safety for fetchone() operations (3 instances)
- **fix(migrate_additional.py)**: Add None safety for fetchone() operations (3 instances)
- **status**: All 8 VS Code type checking errors resolved
- **quality**: All pre-commit hooks passing, proper CHANGELOG maintenance
...
### Correções
- **fix(gestao)**: Rollbacks defensivos adicionais para evitar transação abortada em consultas
...
## [3.3.4] - 2026-02-02 00:00:00


## [3.3.6] - 2026-02-02 00:00:00
